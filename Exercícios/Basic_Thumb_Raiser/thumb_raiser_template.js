        ...
        if (!this.gameRunning) {
            if (this.maze.loaded && this.player.loaded) { // If all resources have been loaded
                ...
                */
                ...
                this.player.object.position.x += 1.5;
                this.player.object.position.z += 2.5;
                ...
                if (this.maze.foundExit(this.player.position)) {
                    ...
                    */
                    if (this.player.keyStates.backward) { // The player is moving backward
                        const newPosition = new THREE.Vector3(this.player.position.x, this.player.position.y, coveredDistance * Math.cos(direction)).add(this.player.position);
                        ...
                        */
                        ...
                        const newPosition = new THREE.Vector3(coveredDistance * Math.sin(direction) + this.player.position.x, this.player.position.y, this.player.position.z).add(this.player.position);
                    ...
                    */
                    this.player.object.newPosition = this.player.position;
