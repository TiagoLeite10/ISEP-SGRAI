    ...
    update(deltaT) {
        ...
        */
        if (centerIncrement.x < 0) { // The ball is moving to the left
            if (this.player1.center.y + this.player1.halfSize.y >= this.center.y - this.radius &&
                this.player1.center.y - this.player1.halfSize.y <= this.center.y + this.radius &&
                this.player1.center.x + this.player1.halfSize.x >= this.center.x - this.radius &&
                this.player1.center.x - this.player1.halfSize.x <= this.center.x - this.radius
        ...
        */
            ...
            if (this.player2.center.y + this.player2.halfSize.y >= this.center.y - this.radius &&
                this.player2.center.y - this.player2.halfSize.y <= this.center.y + this.radius &&
                this.player2.center.x - this.player2.halfSize.x <= this.center.x + this.radius &&
                this.player2.center.x + this.player2.halfSize.x >= this.center.x + this.radius
